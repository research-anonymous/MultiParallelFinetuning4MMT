...
#SBATCH -o /home/dwu/workplace/logs/multi-parallel/out.baseline_2.1.o
#SBATCH -e /home/dwu/workplace/logs/multi-parallel/out.baseline_2.1.e
...
CHECKPOINT_DIR=/ivi/ilps/personal/dwu/checkpoints/multi-parallel/baseline


fairseq-train ${DATA_DIR} \
    --save-dir ${CHECKPOINT_DIR} \
    --langs en,da,de,es,fi,fr,it,nl \
    --lang-pairs en-da,da-en,en-de,de-en,en-es,es-en,en-fi,fi-en,en-fr,fr-en,en-it,it-en,en-nl,nl-en \
