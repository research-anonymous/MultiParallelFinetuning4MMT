...
#SBATCH -o /home/dwu/workplace/logs/multi-parallel/out.europarl_boost.o
#SBATCH -e /home/dwu/workplace/logs/multi-parallel/out.europarl_boost.e
...
# Note that here we use multi-parallel data to finetune.
DATA_DIR=/ivi/ilps/personal/dwu/data/Europarl_multi_parallel/data_bin
CHECKPOINT_DIR=/ivi/ilps/personal/dwu/checkpoints/multi-parallel/europarl-boost
...
fairseq-train ${DATA_DIR} \
    ...
    --max-tokens 8192 --update-freq 1 --patience 3 --max-update 200000 \
    --save-interval-updates 100 --keep-interval-updates 1 \
    --no-epoch-checkpoints --seed 222 --log-format simple --log-interval 20 \
    --skip-invalid-size-inputs-valid-test \
    --finetune-from-model /ivi/ilps/personal/dwu/checkpoints/multi-parallel/baseline/checkpoint_best.pt \
    --fp16
